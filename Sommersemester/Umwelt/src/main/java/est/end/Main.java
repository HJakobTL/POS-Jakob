...
public class Main {
    ...
    private static void testBerechneDurchschnittswert() {
        ...
        System.out.println("Luft: " + umweltBehoerde.berechneDurchschnittLuftmessstation());
        System.out.println("Lärm: " + umweltBehoerde.berechneDurchschnittLaermmessertstation());
    ...
    private static void testZaehleAlleStationenMitZuHohemWert() {
        ...
        System.out.println("Anzahl zu hoher Wert (50): " + umweltBehoerde.zaehleAlleSationenMitZuHohemWert(50));
        System.out.println("Anzahl zu hoher Wert (0): " + umweltBehoerde.zaehleAlleSationenMitZuHohemWert(0));
        System.out.println("Anzahl zu hoher Wert (21): " + umweltBehoerde.zaehleAlleSationenMitZuHohemWert(21));
        System.out.println(umweltBehoerde);
        System.out.println();
    }
    ...
    private static void testSortieren() {
        ...
        System.out.println(umweltBehoerde);
        System.out.println();
        umweltBehoerde.sortiereMessstaionen();
        System.out.println(umweltBehoerde);
        System.out.println();
    }
    ...
    private static void testZeigeNurLaermessstationen() {
        ...
        umweltBehoerde.zeigeNurLaermmessstation();
        System.out.println();
    }
    ...
    private static void testZeigeAlleStationen() {
        ...
        umweltBehoerde.zeigAlleStationen();
        System.out.println();
    }
